...
class TestTestCommand:
    ...
    def test_connection_success(self):
        ...
        with patch.object(ConfigLoader, 'load', return_value=mock_config), \
             patch.object(ConfigLoader, 'get_profile_info', return_value={
                 "url": "https://192.168.1.1",
                 "verify_ssl": True
             }), \
             patch('src.opnsense_mcp.cli.test._test_connection_async', return_value={
                 "success": True,
                 "firmware_status": {"product_name": "OPNsense"}
             }):
