...
@mcp.tool(
    name="traffic_shaper_get_status", description="Get traffic shaper service status and statistics"
)
async def traffic_shaper_get_status(ctx: Context) -> str:
    ...
    try:
        ...
        statistics_response = await client.request(
            "GET", API_TRAFFICSHAPER_SERVICE_STATISTICS, operation="get_traffic_shaper_statistics"
        )
...
@mcp.tool(
    name="traffic_shaper_reconfigure", description="Apply traffic shaper configuration changes"
)
async def traffic_shaper_reconfigure(ctx: Context) -> str:
    ...
    try:
        ...
        response = await client.request(
            "POST", API_TRAFFICSHAPER_SERVICE_RECONFIGURE, operation="reconfigure_traffic_shaper"
        )
...
@mcp.tool(
    name="traffic_shaper_get_settings",
    description="Get general traffic shaper settings and configuration",
)
async def traffic_shaper_get_settings(ctx: Context) -> str:
    ...
    try:
        ...
        response = await client.request(
            "GET", API_TRAFFICSHAPER_SETTINGS_GET, operation="get_traffic_shaper_settings"
        )
...
@mcp.tool(
    name="traffic_shaper_list_pipes",
    description="List all traffic shaper pipes with optional filtering",
)
async def traffic_shaper_list_pipes(ctx: Context) -> str:
    ...
    try:
        ...
        response = await client.request(
            "POST", API_TRAFFICSHAPER_SETTINGS_SEARCH_PIPES, operation="search_traffic_shaper_pipes"
        )
...
@mcp.tool(
    name="traffic_shaper_get_pipe", description="Get details of a specific traffic shaper pipe"
)
async def traffic_shaper_get_pipe(ctx: Context, pipe_uuid: str | None = None) -> str:
...
@mcp.tool(
    name="traffic_shaper_create_pipe",
    description="Create a new traffic shaper pipe for bandwidth limiting",
)
    ...
    try:
        ...
        if bandwidth <= 0:
            raise ValidationError(
                "Bandwidth must be a positive integer", context={"bandwidth": bandwidth}
            )

        if bandwidth_metric not in ["bit/s", "Kbit/s", "Mbit/s", "Gbit/s"]:
            raise ValidationError(
                "Invalid bandwidth metric",
                context={
        ...
        if not (2 <= queue_size <= 100):
            raise ValidationError(
                "Queue size must be between 2 and 100", context={"queue_size": queue_size}
            )
        ...
        response = await client.request(
            ...
            API_TRAFFICSHAPER_SETTINGS_ADD_PIPE,
            data=pipe_data,
            operation="create_traffic_shaper_pipe",
        )
        ...
        if response.get("result") == "saved":
            await client.request(
                "POST",
                API_TRAFFICSHAPER_SERVICE_RECONFIGURE,
                operation="reconfigure_after_pipe_create",
            )
...
@mcp.tool(
    name="traffic_shaper_update_pipe",
    description="Update an existing traffic shaper pipe configuration",
)
async def traffic_shaper_update_pipe(
    ...
    try:
        ...
        current_pipe_response = await client.request(
            "GET",
            f"{API_TRAFFICSHAPER_SETTINGS_GET_PIPE}/{pipe_uuid}",
        ...
        if bandwidth_metric is not None:
            if bandwidth_metric not in ["bit/s", "Kbit/s", "Mbit/s", "Gbit/s"]:
                raise ValidationError(
                    "Invalid bandwidth metric", context={"bandwidth_metric": bandwidth_metric}
                )
        ...
        if scheduler is not None:
            if scheduler not in ["FIFO", "DRR", "QFQ", "FQ-CoDel", "FQ-PIE"]:
                raise ValidationError("Invalid scheduler", context={"scheduler": scheduler})
        ...
        response = await client.request(
            "POST",
            f"{API_TRAFFICSHAPER_SETTINGS_SET_PIPE}/{pipe_uuid}",
            data=pipe_data,
            operation="update_traffic_shaper_pipe",
        )
        ...
        if response.get("result") == "saved":
            await client.request(
                "POST",
                API_TRAFFICSHAPER_SERVICE_RECONFIGURE,
                operation="reconfigure_after_pipe_update",
            )
...
async def traffic_shaper_delete_pipe(ctx: Context, pipe_uuid: str) -> str:
    ...
    try:
        ...
        response = await client.request(
            "POST",
            f"{API_TRAFFICSHAPER_SETTINGS_DEL_PIPE}/{pipe_uuid}",
        ...
        if response.get("result") == "deleted":
            await client.request(
                "POST",
                API_TRAFFICSHAPER_SERVICE_RECONFIGURE,
                operation="reconfigure_after_pipe_delete",
            )
...
async def traffic_shaper_toggle_pipe(ctx: Context, pipe_uuid: str, enabled: bool) -> str:
    ...
    try:
        ...
        response = await client.request(
            "POST",
            f"{API_TRAFFICSHAPER_SETTINGS_TOGGLE_PIPE}/{pipe_uuid}/{enabled_int}",
        ...
        if response.get("result") == "saved":
            await client.request(
                "POST",
                API_TRAFFICSHAPER_SERVICE_RECONFIGURE,
                operation="reconfigure_after_pipe_toggle",
            )
...
@mcp.tool(
    name="traffic_shaper_list_queues",
    description="List all traffic shaper queues with optional filtering",
)
async def traffic_shaper_list_queues(ctx: Context) -> str:
    ...
    try:
        ...
        response = await client.request(
            "POST",
            API_TRAFFICSHAPER_SETTINGS_SEARCH_QUEUES,
            operation="search_traffic_shaper_queues",
        )
...
@mcp.tool(
    name="traffic_shaper_get_queue", description="Get details of a specific traffic shaper queue"
)
async def traffic_shaper_get_queue(ctx: Context, queue_uuid: str | None = None) -> str:
...
@mcp.tool(
    name="traffic_shaper_create_queue",
    description="Create a new traffic shaper queue for weighted bandwidth sharing",
)
async def traffic_shaper_create_queue(
    ctx: Context, pipe_uuid: str, weight: int = 10, description: str = "", enabled: bool = True
) -> str:
    ...
    try:
        ...
        if not (1 <= weight <= 100):
            raise ValidationError("Weight must be between 1 and 100", context={"weight": weight})

        # Verify the pipe exists
        pipe_response = await client.request(
            "GET",
            f"{API_TRAFFICSHAPER_SETTINGS_GET_PIPE}/{pipe_uuid}",
        ...
        response = await client.request(
            ...
            API_TRAFFICSHAPER_SETTINGS_ADD_QUEUE,
            data=queue_data,
            operation="create_traffic_shaper_queue",
        )
        ...
        if response.get("result") == "saved":
            await client.request(
                "POST",
                API_TRAFFICSHAPER_SERVICE_RECONFIGURE,
                operation="reconfigure_after_queue_create",
            )
...
@mcp.tool(
    name="traffic_shaper_update_queue",
    description="Update an existing traffic shaper queue configuration",
)
async def traffic_shaper_update_queue(
    ...
    try:
        ...
        current_queue_response = await client.request(
            "GET",
            f"{API_TRAFFICSHAPER_SETTINGS_GET_QUEUE}/{queue_uuid}",
        ...
        if weight is not None:
            if not (1 <= weight <= 100):
                raise ValidationError(
                    "Weight must be between 1 and 100", context={"weight": weight}
                )
        ...
        response = await client.request(
            "POST",
            f"{API_TRAFFICSHAPER_SETTINGS_SET_QUEUE}/{queue_uuid}",
            data=queue_data,
            operation="update_traffic_shaper_queue",
        )
        ...
        if response.get("result") == "saved":
            await client.request(
                "POST",
                API_TRAFFICSHAPER_SERVICE_RECONFIGURE,
                operation="reconfigure_after_queue_update",
            )
...
async def traffic_shaper_delete_queue(ctx: Context, queue_uuid: str) -> str:
    ...
    try:
        ...
        response = await client.request(
            "POST",
            f"{API_TRAFFICSHAPER_SETTINGS_DEL_QUEUE}/{queue_uuid}",
        ...
        if response.get("result") == "deleted":
            await client.request(
                "POST",
                API_TRAFFICSHAPER_SERVICE_RECONFIGURE,
                operation="reconfigure_after_queue_delete",
            )
...
@mcp.tool(
    name="traffic_shaper_toggle_queue", description="Enable or disable a traffic shaper queue"
)
async def traffic_shaper_toggle_queue(ctx: Context, queue_uuid: str, enabled: bool) -> str:
    ...
    try:
        ...
        response = await client.request(
            "POST",
            f"{API_TRAFFICSHAPER_SETTINGS_TOGGLE_QUEUE}/{queue_uuid}/{enabled_int}",
        ...
        if response.get("result") == "saved":
            await client.request(
                "POST",
                API_TRAFFICSHAPER_SERVICE_RECONFIGURE,
                operation="reconfigure_after_queue_toggle",
            )
...
@mcp.tool(
    name="traffic_shaper_list_rules",
    description="List all traffic shaper rules with optional filtering",
)
async def traffic_shaper_list_rules(ctx: Context) -> str:
    ...
    try:
        ...
        response = await client.request(
            "POST", API_TRAFFICSHAPER_SETTINGS_SEARCH_RULES, operation="search_traffic_shaper_rules"
        )
...
@mcp.tool(
    name="traffic_shaper_get_rule", description="Get details of a specific traffic shaper rule"
)
async def traffic_shaper_get_rule(ctx: Context, rule_uuid: str | None = None) -> str:
...
@mcp.tool(
    name="traffic_shaper_create_rule",
    description="Create a new traffic shaper rule to apply QoS policies",
)
async def traffic_shaper_create_rule(
    ...
    try:
        ...
        if not (1 <= sequence <= 1000000):
            raise ValidationError(
                "Sequence must be between 1 and 1000000", context={"sequence": sequence}
            )
        ...
        try:
            pipe_response = await client.request(
                "GET",
                f"{API_TRAFFICSHAPER_SETTINGS_GET_PIPE}/{target_uuid}",
        ...
        if not target_exists:
            try:
                queue_response = await client.request(
                    "GET",
                    f"{API_TRAFFICSHAPER_SETTINGS_GET_QUEUE}/{target_uuid}",
        ...
        response = await client.request(
            ...
            API_TRAFFICSHAPER_SETTINGS_ADD_RULE,
            data=rule_data,
            operation="create_traffic_shaper_rule",
        )
        ...
        if response.get("result") == "saved":
            await client.request(
                "POST",
                API_TRAFFICSHAPER_SERVICE_RECONFIGURE,
                operation="reconfigure_after_rule_create",
            )
...
@mcp.tool(
    name="traffic_shaper_update_rule",
    description="Update an existing traffic shaper rule configuration",
)
async def traffic_shaper_update_rule(
    ...
    try:
        ...
        current_rule_response = await client.request(
            "GET",
            f"{API_TRAFFICSHAPER_SETTINGS_GET_RULE}/{rule_uuid}",
        ...
        if target_uuid is not None:
            ...
            if not target_exists:
                raise ResourceNotFoundError(
                    f"Target pipe or queue with UUID {target_uuid} not found"
                )
        ...
        response = await client.request(
            "POST",
            f"{API_TRAFFICSHAPER_SETTINGS_SET_RULE}/{rule_uuid}",
            data=rule_data,
            operation="update_traffic_shaper_rule",
        )
        ...
        if response.get("result") == "saved":
            await client.request(
                "POST",
                API_TRAFFICSHAPER_SERVICE_RECONFIGURE,
                operation="reconfigure_after_rule_update",
            )
...
async def traffic_shaper_delete_rule(ctx: Context, rule_uuid: str) -> str:
    ...
    try:
        ...
        response = await client.request(
            "POST",
            f"{API_TRAFFICSHAPER_SETTINGS_DEL_RULE}/{rule_uuid}",
        ...
        if response.get("result") == "deleted":
            await client.request(
                "POST",
                API_TRAFFICSHAPER_SERVICE_RECONFIGURE,
                operation="reconfigure_after_rule_delete",
            )
...
async def traffic_shaper_toggle_rule(ctx: Context, rule_uuid: str, enabled: bool) -> str:
    ...
    try:
        ...
        response = await client.request(
            "POST",
            f"{API_TRAFFICSHAPER_SETTINGS_TOGGLE_RULE}/{rule_uuid}/{enabled_int}",
        ...
        if response.get("result") == "saved":
            await client.request(
                "POST",
                API_TRAFFICSHAPER_SERVICE_RECONFIGURE,
                operation="reconfigure_after_rule_toggle",
            )
...
@mcp.tool(
    name="traffic_shaper_limit_user_bandwidth",
    description="Helper to create per-user bandwidth limiting setup",
)
async def traffic_shaper_limit_user_bandwidth(
    ...
    try:
        ...
        download_pipe_response = await client.request(
            "POST",
            API_TRAFFICSHAPER_SETTINGS_ADD_PIPE,
            data=download_pipe_data,
            operation="create_user_download_pipe",
        )
        ...
        upload_pipe_response = await client.request(
            "POST",
            API_TRAFFICSHAPER_SETTINGS_ADD_PIPE,
            data=upload_pipe_data,
            operation="create_user_upload_pipe",
        )
        ...
        if download_pipe_uuid and upload_pipe_uuid:
            ...
            download_rule_response = await client.request(
                "POST",
                API_TRAFFICSHAPER_SETTINGS_ADD_RULE,
                data=download_rule_data,
                operation="create_user_download_rule",
            )
            ...
            upload_rule_response = await client.request(
                "POST",
                API_TRAFFICSHAPER_SETTINGS_ADD_RULE,
                data=upload_rule_data,
                operation="create_user_upload_rule",
            )
        ...
        await client.request(
            "POST",
            API_TRAFFICSHAPER_SERVICE_RECONFIGURE,
            operation="reconfigure_after_user_bandwidth_setup",
        )
...
@mcp.tool(
    name="traffic_shaper_prioritize_voip",
    description="Helper to set up VoIP traffic prioritization",
)
async def traffic_shaper_prioritize_voip(
    ...
    try:
        ...
        main_pipe_response = await client.request(
            "POST",
            API_TRAFFICSHAPER_SETTINGS_ADD_PIPE,
            data=main_pipe_data,
            operation="create_voip_main_pipe",
        )
        ...
        if main_pipe_uuid:
            ...
            voip_queue_response = await client.request(
                "POST",
                API_TRAFFICSHAPER_SETTINGS_ADD_QUEUE,
                data=voip_queue_data,
                operation="create_voip_priority_queue",
            )
            ...
            data_queue_response = await client.request(
                "POST",
                API_TRAFFICSHAPER_SETTINGS_ADD_QUEUE,
                data=data_queue_data,
                operation="create_data_best_effort_queue",
            )
            ...
            if voip_queue_uuid and data_queue_uuid:
                ...
                voip_rule_response = await client.request(
                    "POST",
                    API_TRAFFICSHAPER_SETTINGS_ADD_RULE,
                    data=voip_rule_data,
                    operation="create_voip_priority_rule",
                )
                ...
                data_rule_response = await client.request(
                    "POST",
                    API_TRAFFICSHAPER_SETTINGS_ADD_RULE,
                    data=data_rule_data,
                    operation="create_data_best_effort_rule",
                )
                results["data_rule"] = data_rule_response

        # Apply configuration
        await client.request(
            "POST", API_TRAFFICSHAPER_SERVICE_RECONFIGURE, operation="reconfigure_after_voip_setup"
        )
...
@mcp.tool(
    name="traffic_shaper_setup_gaming_priority", description="Helper to optimize traffic for gaming"
)
async def traffic_shaper_setup_gaming_priority(
    ...
    try:
        ...
        main_pipe_response = await client.request(
            ...
            API_TRAFFICSHAPER_SETTINGS_ADD_PIPE,
            data=main_pipe_data,
            operation="create_gaming_main_pipe",
        )
        results["main_pipe"] = main_pipe_response
        main_pipe_uuid = main_pipe_response.get("uuid")
        ...
        if main_pipe_uuid:
            ...
            gaming_queue_response = await client.request(
                "POST",
                API_TRAFFICSHAPER_SETTINGS_ADD_QUEUE,
                data=gaming_queue_data,
                operation="create_gaming_priority_queue",
            )
            ...
            interactive_queue_response = await client.request(
                "POST",
                API_TRAFFICSHAPER_SETTINGS_ADD_QUEUE,
                data=interactive_queue_data,
                operation="create_interactive_priority_queue",
            )
            ...
            bulk_queue_response = await client.request(
                "POST",
                API_TRAFFICSHAPER_SETTINGS_ADD_QUEUE,
                data=bulk_queue_data,
                operation="create_bulk_download_queue",
            )
            ...
            if gaming_queue_uuid and interactive_queue_uuid and bulk_queue_uuid:
                ...
                gaming_rule_response = await client.request(
                    "POST",
                    API_TRAFFICSHAPER_SETTINGS_ADD_RULE,
                    data=gaming_rule_data,
                    operation="create_gaming_priority_rule",
                )
                ...
                interactive_rule_response = await client.request(
                    "POST",
                    API_TRAFFICSHAPER_SETTINGS_ADD_RULE,
                    data=interactive_rule_data,
                    operation="create_interactive_priority_rule",
                )
                ...
                bulk_rule_response = await client.request(
                    "POST",
                    API_TRAFFICSHAPER_SETTINGS_ADD_RULE,
                    data=bulk_rule_data,
                    operation="create_bulk_download_rule",
                )
        ...
        await client.request(
            "POST",
            API_TRAFFICSHAPER_SERVICE_RECONFIGURE,
            operation="reconfigure_after_gaming_setup",
        )
...
@mcp.tool(
    name="traffic_shaper_create_guest_limits",
    description="Helper to set up guest network bandwidth limitations",
)
async def traffic_shaper_create_guest_limits(
    ctx: Context,
    guest_network: str,
    max_bandwidth_mbps: int,
    per_user_limit_mbps: int | None = None,
    interface: str = "lan",
) -> str:
    ...
    try:
        ...
        guest_pipe_response = await client.request(
            "POST",
            API_TRAFFICSHAPER_SETTINGS_ADD_PIPE,
            data=guest_pipe_data,
            operation="create_guest_network_pipe",
        )
        ...
        if per_user_limit_mbps and guest_pipe_uuid:
            ...
            guest_queue_response = await client.request(
                "POST",
                API_TRAFFICSHAPER_SETTINGS_ADD_QUEUE,
                data=guest_queue_data,
                operation="create_guest_user_queue",
            )
        ...
        if target_uuid:
            ...
            guest_download_rule_response = await client.request(
                "POST",
                API_TRAFFICSHAPER_SETTINGS_ADD_RULE,
                data=guest_download_rule_data,
                operation="create_guest_download_rule",
            )
            ...
            guest_upload_rule_response = await client.request(
                "POST",
                API_TRAFFICSHAPER_SETTINGS_ADD_RULE,
                data=guest_upload_rule_data,
                operation="create_guest_upload_rule",
            )
            results["guest_upload_rule"] = guest_upload_rule_response

        # Apply configuration
        await client.request(
            "POST", API_TRAFFICSHAPER_SERVICE_RECONFIGURE, operation="reconfigure_after_guest_setup"
        )
